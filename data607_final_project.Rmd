...
```{r }
ggplot(df_final,aes(x=reorder(state,-total_casualty), total_casualty))+geom_bar(stat='identity',width = 0.8,color='red')+theme(axis.text.x = element_text(hjust =20))+coord_flip()
```
...
# References:
Unemployment rate data source: https://www.bls.gov/
US mass shooting casualty data source: https://www.gunviolencearchive.org/
